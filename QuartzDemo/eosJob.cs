...
namespace QuartzDemo
{
    ...
    class eosJob : IJob
    {
        ...
        public CEO getIndex(out string sec_)
        {
            ...
            request.AddHeader("referer", "https://ceo.bi/t/cny_eos.jsp");
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                ...
                double eosprice = double.Parse(rp.price_cny);
                ...
                if (ceo.order!=null)
                {
                    ...
                    {
                        if (double.Parse(o.price) - eosprice > 0.1 && o.type == 1)
                        {
                ...
                else
                {
                        ...
                        buy(sec_, "50", eosprice.ToString("0.00"));
